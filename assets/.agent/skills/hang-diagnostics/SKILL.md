...
**This skill covers hangs.** For hitches, see `swiftui-performance`. For general lag, see `performance-profiling`.
...
**Skills**: metrickit-ref, performance-profiling, swift-concurrency
