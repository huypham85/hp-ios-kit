...
description: |
  ...
  Explicit command: Users can also invoke this agent directly with `/hp:analyze-crash`
# model: sonnet
# color: red
# tools:
  - Bash
...
- `testflight-triage` — Full TestFlight workflow including Organizer
- `memory-debugging` — For memory-related crashes
- `swift-concurrency` — For concurrency-related crashes
- `xcode-debugging` — For build/environment issues
