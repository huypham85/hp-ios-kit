...
4. Use `crash-analyzer` agent to parse: `/hp:analyze-crash`
...
See `crash-analyzer` agent: `/hp:analyze-crash`
...
**Skills:** testflight-triage (Xcode Organizer workflows)

**Agents:** crash-analyzer (automated crash log parsing)

**Commands:** `/hp:analyze-crash`
