...
**Related skills**: `background-processing` (patterns, checklists), `background-processing-ref` (API reference)
...
**Skills**: background-processing, background-processing-ref
