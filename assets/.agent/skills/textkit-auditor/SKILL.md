...
description: |
  ...
  Explicit command: Users can also invoke this agent directly with `/audit textkit`
# model: haiku
# color: cyan
# tools:
  - Glob
...
Use `/skill hp:textkit-ref` for complete TextKit 2 architecture reference, migration patterns from TextKit 1, Writing Tools integration guide, and SwiftUI TextEditor + AttributedString patterns.
```
