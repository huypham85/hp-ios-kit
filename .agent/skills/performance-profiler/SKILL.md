...
description: |
  ...
  Explicit command: Users can also invoke this agent directly with `/hp:profile`
# model: sonnet
# color: orange
# tools:
  - Bash
...
- `performance-profiling` — Manual Instruments workflows
- `memory-debugging` — Memory leak diagnosis
- `swiftui-performance` — SwiftUI-specific profiling
