...
For CarPlay-specific integration patterns, invoke `/skill now-playing-carplay`.
...
For MusicKit-specific integration patterns and hybrid app examples, invoke `/skill now-playing-musickit`.
...
**Skills**: avfoundation-ref, now-playing-carplay, now-playing-musickit
