...
These patterns use NWConnection with completion handlers for apps supporting iOS 12-25. If your app targets iOS 26+, use NetworkConnection with async/await instead (see network-framework-ref skill).
...
**Skills**: networking, network-framework-ref, networking-migration
