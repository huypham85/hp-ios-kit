...
For apps supporting iOS 12-25 that can't use async/await yet, invoke `/skill networking-legacy`:
...
For detailed migration guides from legacy networking APIs, invoke `/skill networking-migration`:
